...
/*
    public static void ConfigureLogbackDirectly(Context context) {
        try {
            ...
            final String LOG_DIR = "MyCameraApp";//AppSettings.getGpsLoggerFolder();
...
*/
    ...
    public static String GetDescriptiveTimeString(int numberOfSeconds,
        ...
        if (numberOfSeconds == 1) {
            return "1sec";//context.getString(R.string.time_onesecond);
        }

        if (numberOfSeconds == 30) {
            return "0.5min";//context.getString(R.string.time_halfminute);
        }

        if (numberOfSeconds == 60) {
            return "1min";//context.getString(R.string.time_oneminute);
        }

        if (numberOfSeconds == 900) {
            return "1/4hr";//context.getString(R.string.time_quarterhour);
        }

        if (numberOfSeconds == 1800) {
            return "0.5h";//context.getString(R.string.time_halfhour);
        }

        if (numberOfSeconds == 3600) {
            return "1h";//context.getString(R.string.time_onehour);
        }

        if (numberOfSeconds == 4800) {
            return "1.5h";//context.getString(R.string.time_oneandhalfhours);
        }

        if (numberOfSeconds == 9000) {
            return "2.5h";// context.getString(R.string.time_twoandhalfhours);
        }
