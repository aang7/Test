...
public class GpsLoggingService extends IntentService {
     ...
     */
    public GpsLoggingService(String name) {
        super(name);
    }
    ...
    public void onCreate() {
        Log.d("GPSLOGSERV 101", "ON created");
    ...
    private void RequestActivityRecognitionUpdates() {
        Log.d("GPSLOGSERV 101", "RequestActivityRecognitionUpdates");
                ...
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(Bundle arg0) {
                        try {
                            ...
                            ActivityRecognition.ActivityRecognitionApi.requestActivityUpdates(googleApiClient, 60 * 1000, activityRecognitionPendingIntent); // 60 en vez de AppSettings.getMinimumLoggingInterval()
                        } catch (Throwable t) {
    ...
    private void StopActivityRecognitionUpdates() {
        Log.d("GPSLOGSERV 101", "StopActivityRecognitionUpdates");
        try {
    ...
    private void RegisterEventBus() {
        Log.d("GPSLOGSERV 101", "BUs register");
        EventBus.getDefault().registerSticky(this);
    }

    private void UnregisterEventBus() {
        Log.d("GPSLOGSERV 101", "UnregisterEventBUs");
        try {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d("GPSLOGSERV 101", "onStartCommand");
        HandleIntent(intent);
    ...
    public void onDestroy() {
        Log.d("GPSLOGSERV 101", "onDestroy");
    ...
    public void onLowMemory() {
        Log.d("GPSLOGSERV 101", "onLowMemory");
        //tracer.error("Android is low on memory!");
        super.onLowMemory();
    }

    private void HandleIntent(Intent intent) {
        Log.d("GPSLOGSERV 101", "HandleIntent");
    ...
    private void CancelAlarm() {
        Log.d("GPSLOGSERV 101", "CancelAlarm");
        if (alarmIntent != null) {
            AlarmManager am = (AlarmManager) getSystemService(ALARM_SERVICE);
            PendingIntent sender = PendingIntent.getBroadcast(this, 0, alarmIntent, PendingIntent.FLAG_UPDATE_CURRENT);
            am.cancel(sender);
    ...
    */
    ...
    private void NotifyClientStarted() {
        Log.d("GPSLOGSERV 101", "NotifyClientStarted");
        //tracer.info("Started");  //getString(R.string.started)
    ...
    public void StopLogging() {
        Log.d("GPSLOGSERV 101", "StopLogging");
        //tracer.debug(".");
        Session.setAddNewTrackSegment(true);
    ...
    private void RemoveNotification() {
        Log.d("GPSLOGSERV 101", "RemoveNotification");
    ...
    private void ShowNotification() {
        Log.d("DEbugg 101", "ShowNotification");
        ...
        annotateIntent.setAction("com.raddapp.radika.gpx_logging.NOTIFICATION_BUTTON");
        ...
        String contentText = "GPS logg Still running"; //getString(R.string.gpslogger_still_running)
        long notificationTime = System.currentTimeMillis();

        if (Session.hasValidLocation()) {
            contentText = "lat"+ ": " + nf.format(Session.getCurrentLatitude()) + ", " //getString(R.string.txt_latitude_short)
                    + "long"+ ": " + nf.format(Session.getCurrentLongitude()); //getString(R.string.txt_longitude_short)
    ...
    private void StartPassiveManager() {
        Log.d("GPSLOGSERV 101", "StartPassiveManager");
    ...
    private boolean userHasBeenStillForTooLong() {
        Log.d("GPSLOGSERV 101", "userHasBeenStillForTooLong");
        return !Session.hasDescription() && !Session.isSinglePointMode() &&
                (Session.getUserStillSinceTimeStamp() > 0 && (System.currentTimeMillis() - Session.getUserStillSinceTimeStamp()) > (60 * 1000));//AppSettings.getMinimumLoggingInterval()
    }


    private void startAbsoluteTimer() {
        Log.d("GPSLOGSERV 101", "startAbsoluteTimer");
        ...
        handler.postDelayed(stopManagerRunnable, 120 * 1000);
    }
    ...
    private Runnable stopManagerRunnable = new Runnable() {
        @Override
        public void run() {
            Log.d("GPSLOGSERV 101", "stopManagerRunnable");
    ...
    private void stopAbsoluteTimer() {
        Log.d("GPSLOGSERV 101", "StopAbsoluteTimer");
    ...
    private void StopGpsManager() {
        Log.d("GPSLOGSERV 101", "StopGpsManager");
        if (towerLocationListener != null) {
    ...
    private void StopPassiveManager() {
        Log.d("GPSLOGSERV 101", "StopPassiveManager");
    ...
    private void ResetCurrentFileName(boolean newLogEachStart) {
        Log.d("GPSLOGSERV 101", "ResetCurrentFileName");
    ...
    void NotifyClientStopped() {
        Log.d("GPSLOGSERV 101", "NotifyClientStopped");

        //tracer.info("Stoped");//getString(R.string.stopped)
    ...
    void RestartGpsManagers() {
        Log.d("GPSLOGSERV 101", "RestartGpsManager");
    ...
    void OnLocationChanged(Location loc) {
        Log.d("GPSLOGSERV 101", "OnLocationChanged");
        ...
        if (!Session.hasDescription() && !Session.isSinglePointMode() && (currentTimeStamp - Session.getLatestTimeStamp()) < ( 5* 1000)) {//AppSettings.getMinimumLoggingInterval()
            return;
        }
    ...
    private boolean isFromValidListener(Location loc) {
        Log.d("GPSLOGSERV 101", "isFromValidListener");
...
*/
    ...
    private void SetDistanceTraveled(Location loc) {
        Log.d("GPSLOGSERV 101", "SetDistanceTraveled");
    ...
    protected void StopManagerAndResetAlarm() {
        Log.d("GPSLOGSERV 101", "StopManagerAndResetAlarm");
    ...
    private void SetAlarmForNextPoint() {
        ...
        nextPointAlarmManager.set(AlarmManager.ELAPSED_REALTIME_WAKEUP,
                SystemClock.elapsedRealtime() + 1 * 1000, pi); //AppSettings.getMinimumLoggingInterval()
    }
    ...
    private void WriteToFile(Location loc) {
        Log.d("GPSLOGSERV 101", "WriteToFile");
    ...
    void SetSatelliteInfo(int count) {
        Log.d("GPSLOGSERV 101", "SetSatelliteInfo");
   ...
   /* public void OnNmeaSentence(long timestamp, String nmeaSentence) {
    ...
    public class GpsLoggingBinder extends Binder {
        public GpsLoggingService getService() {
            Log.d("GPSLOGSERV 101", "GpsLoggingServ..getService");
    ...
    public void onEvent(CommandEvents.RequestToggle requestToggle){
        Log.d("GPSLOGSERV 101", "onEvent ReqToggle");
    ...
    public void onEvent(CommandEvents.RequestStartStop startStop){
        Log.d("GPSLOGSERV 101", "onEvent startStop");
    ...
    public void onEvent(CommandEvents.AutoSend autoSend){
        Log.d("GPSLOGSERV 101", "onEvent autoSend");
    ...
    public void onEvent(CommandEvents.Annotate annotate){
        Log.d("GPSLOGSERV 101", "onEvent annotate");
    ...
    public void onEvent(CommandEvents.LogOnce logOnce){
        Log.d("GPSLOGSERV 101", "onEvent logOnce");
    ...
    public void onEvent(ServiceEvents.ActivityRecognitionEvent activityRecognitionEvent){
        Log.d("GPSLOGSERV 101", "onEvent activityRecognitionEvent");
