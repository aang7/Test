...
public class H7ConnectThread  extends Thread{
    ...
    public H7ConnectThread(BluetoothDevice device, HRFragment ac) {
        Log.i("H7ConnectThread", "Starting H7 reader BTLE");
        this.ac=ac;
        gat = device.connectGatt(this.ac.getActivity(), false, btleGattCallback); // Connect to the device and store the server (gatt)
    }
